...
//    this.querySelectorAll("p:first-of-type").innerText = "mouseout"
//   })
//  }
// })
// overout.forEach((item,index)=>{
...
const enterleavetOut = document.querySelector("div.out.enterleave")
enterleavetOut.addEventListener("mouseenter",function(){
 const pItems = this.querySelectorAll("p")
 pItems[0].innerText="mouseenter"
 pItems[3].innerText=++e
})

const enterleavetIn = document.querySelector("div.in.enterleave")
enterleavetIn.addEventListener("mouseenter",function(){
 const pItems = this.querySelectorAll("p")
 pItems[0].innerText = "mouseenter"
